...
│   │   ├── ImageUploadInput.tsx   # ক্লাউড ইমেজ আপলোডার UI (ImgBB API + Auto WebP Compression + Drag-and-Drop)
...
| **`src/lib/imageUploader.ts`** | ক্লায়েন্ট-সাইড ব্রাউজারেই ১-৫MB ইমেজ ফাইলকে অটোমেটিক লাইটওয়েট WebP ফরম্যাটে কম্প্রেস করে ImgBB ক্লাউড API (`ac5681114bf4c46f44ddfcd035d51afb`) এ আপলোড ও ডিরেক্ট পার্মানেন্ট ইমেজ লিংক রিটার্ন করার ইঞ্জিন। |
| **`src/components/ImageUploadInput.tsx`** | রিয়্যূজেবল ইমেজ আপলোড কম্পোনেন্ট। ড্র্যাগ-অ্যান্ড-ড্রপ, ১-ক্লিক ফাইল সিলেক্ট, লাইভ কম্প্রেস স্ট্যাটাস (যেমন: `2.4 MB ➔ 82 KB (96% saved)`) এবং অটো ডিরেক্ট লিংক ইনপুট হ্যান্ডল করে। |
...
| **`src/App.tsx`** | মূল রাউটার এবং হাই-পারফরম্যান্স স্প্লিটিং ইঞ্জিন। `React.lazy` ও `Suspense` এর মাধ্যমে ১৮+ পেজকে কোড-স্প্লিট করে ইনিশিয়াল মোবাইল বান্ডেল সাইজ ৭০%+ কমিয়ে পেজস্পিড ৯০+ নিশ্চিত করে। |
| **`vite.config.ts`** | বিল্ড অপটিমাইজেশন ও ম্যানুয়াল চাঙ্কিং কনফিগারেশন (`vendor-react`, `vendor-motion`, `vendor-query`, `vendor-supabase`, `vendor-icons`)। |
